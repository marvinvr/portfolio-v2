...
<iframe src="https://tools.marvinvr.ch/model-of-the-solar-system/" width="100%" height="600" frameborder="0" style="border-radius: 8px; margin: 20px 0;"></iframe>
...
You can also open it in full screen by clicking here: [Model of the Solar System](https://tools.marvinvr.ch/model-of-the-solar-system/).

The source code is available on [GitHub](https://github.com/marvinvr/toolbox/tree/main/model-of-the-solar-system) if you're interested.